...
program
  ...
  .option('-c, --xConfig [xConfig]', 'config file of zwebpack')
  .option('-e, --entry [entry]', 'The entry of zwebpack', './src/index.js')
  .option('-p, --path [path]', 'The output path of zwebpack', './dist')
